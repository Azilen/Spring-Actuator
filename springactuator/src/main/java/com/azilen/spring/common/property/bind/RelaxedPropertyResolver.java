 ...
 */
package com.azilen.spring.common.property.bind;
...
/**
 * {@link PropertyResolver} that attempts to resolve values using
 * {@link RelaxedNames}.
 *
 * @author Phillip Webb
 * @see RelaxedNames
...
public class RelaxedPropertyResolver implements PropertyResolver {
    ...
    /**
     * Return a Map of all values from all underlying properties that start with
     * the specified key. NOTE: this method can only be used if the underlying
     * resolver is a {@link ConfigurableEnvironment}.
     *
     * @param keyPrefix the key prefix used to filter results
     * @return a map of all sub properties starting with the specified key
     * prefix.
