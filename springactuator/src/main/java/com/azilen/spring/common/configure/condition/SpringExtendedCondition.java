 ...
 */
public abstract class SpringExtendedCondition implements Condition {
	...
	protected final boolean matches(ConditionContext context,
		...
		if (condition instanceof SpringExtendedCondition) {
			return ((SpringExtendedCondition) condition).getMatchOutcome(context, metadata)
					.isMatch();
		}
