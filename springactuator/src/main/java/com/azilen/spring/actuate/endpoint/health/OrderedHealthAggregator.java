...
/**
 * Default {@link HealthAggregator} implementation that aggregates
 * {@link Health} instances and determines the final system state based on a
 * simple ordered list.
 * <p>
 * If a different order is required or a new {@link Status} type will be used,
 * the order can be set by calling {@link #setStatusOrder(List)}.
 *
