 ...
 *
 * <pre class="code">
 * try { // do some test to determine state of component return new
 * Health.Builder().up().withDetail("version", "1.1.2").build(); } catch
 * (Exception ex) { return new Health.Builder().down(ex).build(); }
 * </pre>
 *
