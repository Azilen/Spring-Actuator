...
import com.azilen.spring.admin.client.config.AdminClientProperties;
import com.azilen.spring.admin.client.config.AdminProperties;
...
import com.azilen.spring.admin.client.model.Application;
...
public class ApplicationRegistrator
{
    ...
    public boolean register()
    {
        ...
        LOGGER.debug("Going to register application::" + self.getName());
    ...
    public void deregister()
    {
        ...
        LOGGER.debug("Going to deregister application::" + client.getName());
        if(id != null)
        {
            for(String adminUrl : admin.getAdminUrl())
            {
